...
def varify(Total_Accounts):
    ...
    try:
        ...
        if Age>18:
            ...
            if PAN_NO=="yes" and Driving_licence=="yes":
            
                print("*"*30,"You Are Eligible For Create Account","*"*30)
                acc_no=sorted(list(Total_Accounts.keys()))[-1]+1
...
def Required_Documents():
    ...
    if Address_proof=="yes" and proof_of_identification=="yes" and proof_of_age=="yes":
        return True
    else:
        return False
